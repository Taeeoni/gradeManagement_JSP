...
<body>
	...
	<form method="post" action="http://localhost:8888/ud/search">
		<div>
			<span>조회할 학번 </span> <input type="number" name="stu_id" /> <input
		...
		<table cellspacing=1 width=400 border=1>
			...
			<tr>
				<td width=100>학년</td>
				<td><input type="search" name='class' /></td>
			</tr>
			<tr>
				<td width=100>시험이름</td>
				<td><input type="search" name='testName' /></td>
			</tr>
			<tr>
				<td width=100>이름</td>
